...
pygame.mixer.init()
k1 = pygame.mixer.Sound("sounds/kill1.mp3")
k2 = pygame.mixer.Sound("sounds/kill2.mp3")
k3 = pygame.mixer.Sound("sounds/kill3.mp3")
k4 = pygame.mixer.Sound("sounds/kill4.mp3")
w1 = pygame.mixer.Sound("sounds/alienwin.mp3")
